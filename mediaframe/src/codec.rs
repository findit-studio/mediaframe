...
//! 1. `cargo xtask sync` — refreshes `xtask/vendor/ffmpeg-codecs.txt`
//!    by fetching FFmpeg n8.1 `libavcodec/codec_desc.c` (curl).
//! 2. `python3 scripts/gen-codec.py` — regenerates this file from the
//!    vendored table (deterministic; sorted by media-type then name).
//!
...
/// `xtask/vendor/ffmpeg-codecs.txt` of media type `video` is
...
///
/// Generated from FFmpeg n8.1 `libavcodec/codec_desc.c` — every codec in
/// `xtask/vendor/ffmpeg-codecs.txt` of media type `audio` is
/// a named variant here. The [`Self::Other`] arm is the lossless escape
/// for anything not enumerated (e.g. a codec added in a future FFmpeg
/// release before this enum is regenerated).
///
...
/// Subtitle codec family.
///
/// Generated from FFmpeg n8.1 `libavcodec/codec_desc.c` — every codec in
/// `xtask/vendor/ffmpeg-codecs.txt` of media type `subtitle` is
/// a named variant here. The [`Self::Other`] arm is the lossless escape
/// for anything not enumerated (e.g. a codec added in a future FFmpeg
/// release before this enum is regenerated).
///
...
impl SubtitleCodec {
    ...
    pub fn is_image_based(&self) -> bool {
        matches!(self, Self::DvbSubtitle | Self::DvdSubtitle | Self::HdmvPgsSubtitle | Self::Xsub)
    }
}
